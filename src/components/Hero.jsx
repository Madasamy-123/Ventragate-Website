    ...
    >
      ...
      <div
        ...
        className="
          ...
          rounded-full bg-teal-300 blur-[110px] z-[1]
          opacity-0
          sm:opacity-10 sm:w-[22rem] sm:h-[22rem]
          lg:opacity-10 lg:w-[26rem] lg:h-[26rem]
          2xl:opacity-20 2xl:w-[40rem] 2xl:h-[40rem]
        "
      />
      ...
      <div
        ...
        className="
          ...
          sm:opacity-10 sm:w-[22rem] sm:h-[22rem]
          lg:opacity-10 lg:w-[26rem] lg:h-[26rem]
          2xl:opacity-15 2xl:w-[40rem] 2xl:h-[40rem]
        "
      />
      ...
      >
        ...
        <div
          className="
            w-full lg:w-1/2
            pt-16 lg:pt-[5rem] xl:pt-[6.25rem]
        ...
        >
          ...
          <button
            ...
            className="
              mt-6 bg-teal-600 text-white
              h-[2.75rem] w-[12.5rem]
              sm:h-[3.25rem] sm:w-[15.375rem]
        ...
        <div
          className="
            ...
            pt-12 lg:pt-[5rem] xl:pt-[6.25rem]
          "
        >
          <img
            src={heroImg}
